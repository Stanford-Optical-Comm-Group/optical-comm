...
%% Bit error probabilities for square (and rectangular) and cross QAM constellations. 
% The Matlab function berawgn only works for rectangular/square constellations.
